...
```shell
curl -X GET "https://api.hollaex.com/v2/admin/stakes"
```
  ...
  "data": [
    {
      ...
      "disclaimer": "Test",
      "paused_date": null,
      "created_at": "2023-12-04T13:57:38.457Z",
      "updated_at": "2024-01-15T06:49:09.734Z",
      "reward": 0.022916666666666655
    }
  ]
}
```
Get exchange stakes information
### HTTP Request

`GET https://api.hollaex.com/v2/admin/stakes`
